            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex gap-4 md:gap-6 mb-6">
                    ...
                    <div className="flex-1">
                        ...
                        {/* Products Grid */}
                        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 mx-auto mb-32 auto-rows-fr">
