...
export async function getMongoClient() {
  ...
  if (globalForMongo._mongoClient && globalForMongo._mongoClient.topology) {
    try {
      ...
      console.warn('[MongoDB] Connection ping failed, will recreate on next request', e.message)
      // Connection dead, close it and mark for recreation
      try {
  ...
  // Create new connection with aggressive timeouts for Vercel
